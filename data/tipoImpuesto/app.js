...
angular.module('scotchApp').controller('tipoImpuestoController', function ($scope, $route) {
	...
	jQuery(function($) {
	    ...
	    jQuery(grid_selector).jqGrid({
	        url: 'data/tipoImpuesto/xml_tipoImpuesto.php',
	        autoencode: false,
	        datatype: "xml",
			height: 200,
	        ...
	        editurl: "data/tipoImpuesto/app.php",
