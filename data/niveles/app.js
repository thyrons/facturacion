...
angular.module('scotchApp').controller('nivelesController', function ($scope, $route) {
	...
	jQuery(function($) {
	    ...
	    jQuery(grid_selector).jqGrid({
	        url: 'data/niveles/xml_niveles.php',
	        autoencode: false,
	        datatype: "xml",
			height: 200,
			colNames:['ID','NOMBRE'],
	        ...
	        editurl: "data/niveles/app.php",
	        caption: "LISTA FUNCIONES / NIVELES"
	    });
	        ...
	        afterSubmit: function(response)  {
                ...
                if(retorno == '2'){
                	...
                	if(retorno == '3') {
	                	...
	                	$.gritter.add({
							title: 'Mensaje',
							text: 'Error al agregar Regitro <i class="ace-icon fa fa-spinner fa-spin green bigger-125"></i>',
							time: 1000				
						});
	                	redireccionar();
	                }
	        ...
	        afterSubmit: function(response)  {
                ...
                if(retorno == '1') {
                	...
                	if(retorno == '3') {
	                	...
	                	$.gritter.add({
							title: 'Mensaje',
							text: 'Error al modificar Regitro <i class="ace-icon fa fa-spinner fa-spin green bigger-125"></i>',
							time: 1000				
						});
	                	redireccionar();
	                }
