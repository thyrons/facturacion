...
angular.module('scotchApp').controller('tipoRetencionController', function ($scope, $route) {
	...
	jQuery(function($) {
	    ...
	    jQuery(grid_selector).jqGrid({
	        url: 'data/tipoRetencion/xml_tipoRetencion.php',
	        autoencode: false,
	        datatype: "xml",
			height: 200,
	        ...
	        editurl: "data/tipoRetencion/app.php",
