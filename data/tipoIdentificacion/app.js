...
angular.module('scotchApp').controller('tipoIdentificacionController', function ($scope, $route) {
	...
	jQuery(function($) {
	    ...
	    jQuery(grid_selector).jqGrid({
	        url: 'data/tipoIdentificacion/xml_tipoIdentificacion.php',
	        autoencode: false,
	        datatype: "xml",
			height: 200,
			colNames:['ID','CÓDIGO','NOMBRE'],
			colModel:[
	        ...
	        editurl: "data/tipoIdentificacion/app.php",
