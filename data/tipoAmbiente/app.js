...
angular.module('scotchApp').controller('tipoAmbienteController', function ($scope, $route) {
	...
	jQuery(function($) {
	    ...
	    jQuery(grid_selector).jqGrid({
	        url: 'data/tipoAmbiente/xml_tipoAmbiente.php',
	        autoencode: false,
	        datatype: "xml",
			height: 200,
	        ...
	        editurl: "data/tipoAmbiente/app.php",
