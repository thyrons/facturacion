...
angular.module('scotchApp').controller('tipoComprobanteController', function ($scope, $route) {
	...
	jQuery(function($) {
	    ...
	    jQuery(grid_selector).jqGrid({
	        url: 'data/tipoComprobante/xml_tipoComprobante.php',
	        autoencode: false,
	        datatype: "xml",
			height: 200,
	        ...
	        editurl: "data/tipoComprobante/app.php",
