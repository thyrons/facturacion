...
angular.module('scotchApp').controller('tipoEmisionController', function ($scope, $route) {
	...
	jQuery(function($) {
	    ...
	    jQuery(grid_selector).jqGrid({
	        url: 'data/tipoEmision/xml_tipoEmision.php',
	        autoencode: false,
	        datatype: "xml",
			height: 200,
	        ...
	        editurl: "data/tipoEmision/app.php",
	        caption: "TIPOS DE EMISIÓN"
	    });
